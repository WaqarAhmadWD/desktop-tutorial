        ...
        <div>
          <div class="rounded-lg border border-default-200 p-6">
            ...
            <div class="mb-6 grid gap-6 lg:grid-cols-2">
              ...
              <div v-if="data.role == 'Restaurant Admin'">
                <label
                  for="countries"
                  class="mb-2 block text-sm font-medium text-default-900"
                ...
                <select
                  id="countries"
                  class="text-gray-900 text-sm rounded-lg block w-full p-2.5"
                  v-model="data.associatedRestaurant"
                >
...
const { createUser, fetchRest } = superAdminStore;
const { restaurants, loading } = storeToRefs(superAdminStore);
...
const submitUser = () => {
  if (data.value.role == "Super Admin") {
    data.value.associatedRestaurant = null;
  }
