<template>
  <div class="w-full lg:ps-64 px-16">
    <div class="page-content space-y-6 p-6">
      <div class="flex w-full items-center justify-between">
        <h4 class="text-xl font-medium">Edit Booking</h4>
        <ol
          ...
          <div class="rounded-lg border border-default-200 p-6">
            <form id="tabPersonalDetail" role="tabpanel">
              <div class="mb-6 grid gap-6 lg:grid-cols-2">
                ...
                <div class="mb-6 grid gap-6 lg:grid-cols-2">
                  <div>
                    <label for="table" class="mb-2 block text-sm font-medium"
                      >Table</label
                    >
                    <select
                      id="table"
                    ...
                    >
                      ...
                      <option>Food Zone</option>
                      <option>ABC Rest</option>
                    </select>
                  </div>
                  <div>
              ...
              <div class="flex flex-wrap justify-end gap-4">
                <button
                  type="reset"
                  class="flex items-center justify-center gap-2 rounded-lg bg-red-500/10 px-6 py-2.5 text-center text-sm font-semibold text-red-500 shadow-sm transition-colors duration-200 hover:bg-red-500 hover:text-white"
                >
                  <svg
                    stroke="currentColor"
                    fill="none"
