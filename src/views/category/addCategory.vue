...
const restaurantStore = useRestaurantAdminStore();
const { createCategory } = restaurantStore;
const { loading } = storeToRefs(restaurantStore);
const data = ref({
  name: "",
  description: "",
});
const submitCateogry = async () => {
