                    ...
                    <div class="md:flex">
                        <div class="w-full p-3">
                            <div class="relative h-48 rounded-lg border-dashed border-2 border-[#f6821d] bg-[#fef1e8] flex justify-center items-center">
                              <div class="absolute" v-if="data.logo">
                              <img :src="data.logo" alt="Selected Image" />
                              </div>
                            <div class="absolute">
                ...
                <div class="max-w-md mx-auto rounded-lg overflow-hidden md:max-w-xl">
                    <div class="md:flex">
                        <div class="w-full py-3">
                            <div class="relative h-24 rounded-lg border-dashed border-2 border-[#f6821d] bg-[#fef1e8] flex justify-center items-center">
         ...
         <div class="flex items-center justify-between gap-4">
            ...
            <div class="w-full max-w-[7rem] ml-4">
               ...
               <div class="flex flex-wrap justify-end gap-4">
                  <button @click="submitRest" type="submit" class="flex items-center justify-center gap-2 rounded-lg bg-[#f58220] px-6 py-2.5 text-center text-sm font-semibold text-white shadow-sm transition-colors duration-200 hover:bg-[#f97316]">
...
const { createRest} = superAdminStore;
const {loading} =storeToRefs(superAdminStore);
const submitRest = () =>{
   createRest(data.value);
}
const data = ref({
  name: "",
  address: "",
